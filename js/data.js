...
export const poems = [
  ...
  },
  {
    ...
    tags: ['romantic', 'reflective'],
    featured: false,
    excerpt: `My wildflowers in your closet\nYour departure in my…`,
  ...
  },
  {
    ...
    featured: false,
    excerpt: `The city sighs in silver threads\nweaving stories through the streets…`,
  ...
  },
  {
    ...
    tags: ['reflective', 'spoken word'],
    featured: false,
    excerpt: `There's a language at the bottom\nwhere light gives up its name…`,
  ...
  },
  {
    ...
    featured: false,
    excerpt: `You are the melody I've been humming\nin the space between my breaths…`,
  ...
  {
    id: 'beautiful-great',
    title: 'Beautiful, Great',
    authorId: 'sno',
    tags: ['reflective', 'spoken word'],
    featured: true,
    excerpt: `Grace, A derivative of Mercy.\n Mercy needs Patience.\nPatience requires Faith...`,
    fullText: `Grace, A derivative of Mercy.\nMercy needs Patience.\nPatience requires Faith.\nFaith is the substance of Hope,\nHope that it ends in Joy.\n\nIs that his Grant?\nA Grant for being Frank\nFor Frank-ness demands Valour,\nWithout which there's no Victor.\nOnly a Victor may 'Marshall' Grace.\nAnd now I must stop for I see the problem.`,
    likes: 42,
    date: 'Just now',
  }
];
