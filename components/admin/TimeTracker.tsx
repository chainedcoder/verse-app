...
export const TimeTracker = ({ timer }: { timer?: Timer | null }) => {
  ...
  if (!timer) {
    return (
      <div className="card admin-stat-card yellow" style={{ background: 'linear-gradient(135deg, #fffdf7 0%, #fdf4dd 100%)', borderRadius: '32px', padding: '24px', flex: 1, boxShadow: '0 1px 2px 0 rgb(0 0 0 / 0.05)', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '340px', minWidth: '280px', border: 'none' }}>
        <button onClick={() => router.push('/timers')} style={{ position: 'absolute', top: '24px', right: '24px', width: '48px', height: '48px', background: 'white', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', cursor: 'pointer', boxShadow: '0 1px 2px 0 rgb(0 0 0 / 0.05)', color: '#111827' }}>
          <IconArrowUpRight />
        </button>
        <p style={{ color: '#6b7280' }}>No active timers</p>
      </div>
    );
  }
  ...
  return (
    <div className="card admin-stat-card yellow" style={{ background: 'linear-gradient(135deg, #fffdf7 0%, #fdf4dd 100%)', borderRadius: '32px', padding: '24px', flex: 1, boxShadow: '0 1px 2px 0 rgb(0 0 0 / 0.05)', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', minHeight: '340px', minWidth: '280px', border: 'none' }}>
       <button onClick={() => router.push('/timers')} style={{ position: 'absolute', top: '24px', right: '24px', width: '48px', height: '48px', background: 'white', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', cursor: 'pointer', boxShadow: '0 1px 2px 0 rgb(0 0 0 / 0.05)', zIndex: 10, color: '#111827' }}>
        <IconArrowUpRight />
      </button>
      <h3 style={{ fontSize: '22px', fontWeight: 400, width: '100%', textAlign: 'left', marginBottom: '24px', color: '#1f2937', paddingRight: '64px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', margin: 0 }}>{timer.name}</h3>
      ...
      <div style={{ position: 'relative', width: '180px', height: '180px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '8px', marginBottom: '32px' }}>
        ...
        <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', transform: 'rotate(-90deg)' }} viewBox="0 0 180 180">
          <circle cx="90" cy="90" r="80" stroke="#1c1c1c" strokeWidth="2" fill="none" strokeDasharray="3 10" />
          {/* Yellow progress arc */}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '8px' }}>
          <span style={{ fontSize: '44px', fontWeight: 300, letterSpacing: '-0.02em', lineHeight: 1, marginBottom: '4px', color: '#111827' }}>{formatTime(timer.remainingSeconds)}</span>
          <span style={{ color: '#6b7280', fontSize: '15px' }}>Work Time</span>
        </div>
      </div>

      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', padding: '0 8px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <button onClick={() => toggleTimer(timer.id)} style={{ width: '52px', height: '52px', background: 'white', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', cursor: 'pointer', boxShadow: '0 1px 2px 0 rgb(0 0 0 / 0.05)', color: '#111827' }}>
