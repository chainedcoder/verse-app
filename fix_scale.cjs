  ...
  return (
    <div style={outerStyle}>
      <div ref={innerRef} style={{ ...innerStyle, justifyContent: "center", alignItems: "center", textAlign: "center" }}>
        ...
        <div style={{ position: "absolute", bottom: \`\${padding}px\`, fontSize: \`\${Math.max(12, width * 0.015)}px\`, opacity: 0.4, fontFamily: "'Inter', sans-serif" }}>
          verse.app
        </div>
      </div>
    </div>
...
fs.writeFileSync('components/ExportEngine.jsx', content);
console.log('Fixed ExportEngine.jsx scaling logic');
